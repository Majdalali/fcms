    ...
    <div class="pt-10 h-full lg:w-[80%]">
      ...
      >
        <template v-slot:text>
          <h1
            v-if="value.length > 0"
            class="cardValue uppercase text-lg dark:text-gray-200"
          ...
          >
            ...
            <div>
              <p>
                Submitted at:
                <span class="text-slate-700 dark:text-orange-100 capitalize">{{
          ...
          <h1 v-else class="cardValue uppercase text-lg dark:text-gray-200">
