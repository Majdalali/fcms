      ...
      <v-row>
        ...
        >
          <div class="pt-4 upperDiv">
            <h1 class="text-3xl font-medium title">Calendar</h1>
            <p class="text-base titleDes font-light">
              Here you can find all the important dates and deadlines.
            </p>
          </div>
...
const uploadFiles = async () => {
  ...
  formData.append("submissionType", "calendarFiles");
  try {
...
onMounted(async () => {
  ...
  try {
    const responseMain = await axios.get(`${apiUrl}/api/files/calendarFiles`, {
      headers: {
