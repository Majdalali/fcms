<template>
  ...
  >
    <v-container fluid>
        ...
        >
          <div class="pt-4 upperDiv">
            <h1 class="text-3xl font-medium title">
              E-Thesis & Graduation Forms
            </h1>
            <p class="text-base titleDes font-light">
              Here you can find all the forms related to your graduation and
              thesis submission.
            </p>
          </div>
      ...
      <p class="mt-5 font-medium text-red-500">{{ errorMessage }}</p>
    </v-container>
    <v-snackbar
      :timeout="2000"
      color="indigo"
...
const uploadFiles = async () => {
  ...
  formData.append("submissionType", "eThesisForms");
  try {
...
onMounted(async () => {
  ...
  try {
    const responseMain = await axios.get(`${apiUrl}/api/files/eThesisForms`, {
      headers: {
