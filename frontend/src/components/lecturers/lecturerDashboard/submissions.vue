  ...
  <div class="mt-10">
    ...
    <div class="lg:w-4/5 mt-5">
      ...
      <v-alert
        ...
        variant="outlined"
        class="my-4"
        text="Student has not submitted any files yet"
      ></v-alert>
    </div>
  </div>
</template>
...
const emptySubmissions = ref(false);
const search = ref("");
const headers = ref([
...
onMounted(async () => {
  ...
  if (filesSubmission.value.length === 0) {
    emptySubmissions.value = true;
  }
});
