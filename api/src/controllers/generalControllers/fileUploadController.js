...
async function uploadNominationsFile(files, lecturerId) {
  const submissionType = "nominationsCVs";
  ...
  try {
    ...
    // Call the saveDataSubmission function from your model with submissionType and fileSubmissionData
    const result = await FileSubmission.saveDataSubmission(
      submissionType,
      fileSubmissionData
    );

    // Return the autogeneratedName as the CVFileId
    return result.autogeneratedName;
  } catch (error) {
    console.error(error);
